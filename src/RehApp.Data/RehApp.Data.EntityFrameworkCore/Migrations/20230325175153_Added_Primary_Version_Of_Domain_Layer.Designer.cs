...
namespace RehApp.Data.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20230325175153_Added_Primary_Version_Of_Domain_Layer")]
    partial class AddedPrimaryVersionOfDomainLayer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RehApp.Domain.RelationalDatabase.Entities.AppealDesc", b =>
                {
                    b.HasOne("RehApp.Domain.RelationalDatabase.Entities.Appeal", "Appeal")
                        .WithMany()
            ...
            modelBuilder.Entity("RehApp.Domain.RelationalDatabase.Entities.ApplicationUserDesc", b =>
                {
                    b.HasOne("RehApp.Domain.RelationalDatabase.Entities.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("RehApp.Domain.RelationalDatabase.Entities.DiaryDesc", b =>
                {
                    ...
                    b.HasOne("RehApp.Domain.RelationalDatabase.Entities.Diary", "Diary")
                        .WithMany()
            ...
            modelBuilder.Entity("RehApp.Domain.RelationalDatabase.Entities.ExerciseDesc", b =>
                {
                    ...
                    b.HasOne("RehApp.Domain.RelationalDatabase.Entities.Exercise", "Exercise")
                        .WithMany()
            ...
            modelBuilder.Entity("RehApp.Domain.RelationalDatabase.Entities.ExerciseParamsDesc", b =>
                {
                    ...
                    b.HasOne("RehApp.Domain.RelationalDatabase.Entities.ExerciseParams", "ExerciseParams")
                        .WithMany()
                        .HasForeignKey("ExerciseParamsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RehApp.Domain.RelationalDatabase.Entities.PostDesc", b =>
                {
                    ...
                    b.HasOne("RehApp.Domain.RelationalDatabase.Entities.Post", "Post")
                        .WithMany()
            ...
            modelBuilder.Entity("RehApp.Domain.RelationalDatabase.Entities.ReviewDesc", b =>
                {
                    ...
                    b.HasOne("RehApp.Domain.RelationalDatabase.Entities.Review", "Review")
                        .WithMany()
